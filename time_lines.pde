class TimeLines extends RunableSketch {
  final float min_vel = 20.0;
  final float max_vel = 50.0;
  
  final float min_length = 100;
  final float max_length = 500;
  
  final float min_chronoton_radius = 2.5;
  final float max_chronoton_radius = 7.5;
  
  final float delta_chronoton_radius = max_chronoton_radius - min_chronoton_radius;
  
  final float time_line_spawn_probability = 0.9;
  
  final float chronoton_spawn_probability = 0.4;
